...
\textcolor{red}{Da qui spostalo alla fine dell'introduzione}
...
\textcolor{red}{da qui in poi mi sembra già detto}
...
\textcolor{red}{da qui, puoi spostarlo alla fine dell'introduzione}
...
\textcolor{red}{anche questo già detto, ma con riferimenti diversi. omogeneizza un po'}
...
\textcolor{red}{anche qui c'è tanta ripetizione, ma siccome mi sembra scritto meglio forse puoi tenere questa parte qui. Potresti inserire qualche schema simile a quelli che sono nel lavoro di Jeanne}
...
\textcolor{red}{per questo discorso puoi mettere le figure delle immagini SEM che ci sono, per esempio, nel lavoro dei turchi}

\subsection{Cellulosa} \textcolor{red}{questa parte uniscila a quello che c'è sopra, sennò è di nuovo una ripetizione.}
...
\textcolor{red}{questa parte la potresti separare perché non riguarda strettamente le vespe. Quanti paper esistono che descrivono il contenuto nelle varie cellulose nei nidi delle vespe? secondo me non tante. Per esempio, Larsson 1997 parla di stoffa e non di vespe}
...
\textcolor{red}{da qui in poi è quello che hai fatto te, quindi da qui in poi va nei risultati}
