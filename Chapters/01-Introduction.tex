...
L'altra tipologia è rappresentata da nidi detti stelocittari gimnodomidai, realizzati per esempio da specie del genere Polistes dove si osserva il favo scoperto sospeso tramite un sottile peduncolo \cite{Jeanne}. 
...
Si può osservare anche come le fibre utilizzate dalle vespinae siano significativamente più corte da quelle utilizzate dalle polistine per la nidificazione. \cite{Bagriacik2013}
