...
\textcolor{red}{sicuramente devi citare qualche pubblicazione di Turillazzi}
...
Un altro elemento caratteristico delle specie del genere Polistes è l'applicazione di una secrezione ghiandolare repellente sul peduncolo per la difesa chimica contro le formiche \cite{Jeanne}. \textcolor{red}{Turillazzi ha pubblicato diversa roba sui materiali del peduncolo, dai un'occhiata}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1\textwidth]{Spettro_prot_vero.png}
